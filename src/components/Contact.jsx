  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await emailjs.send(
        ...
        {
          from_name: form.name,
          to_name: 'Adewale Humphrey Ogunfusika',
          from_email: form.email,
          to_email: 'a.ogunfusika@gmail.com',
      ...
      <motion.div
        ...
        <form
          ...
          <button
            ...
            onMouseOver={() => formRef.current.querySelector('.contact-btn').setAttribute('src', sendHover)}
            onMouseOut={() => formRef.current.querySelector('.contact-btn').setAttribute('src', send)}>
...
//     emailjs
//       .send(
//         'service_nsfk72v', // paste your ServiceID here (you'll get one when your service is created).
//         'template_r1f41gl', // paste your TemplateID here (you'll find it under email templates).
//         {
//           from_name: form.name,
//           to_name: 'Adewale Humphrey Ogunfusika', // put your name here.
//           from_email: form.email,
//           to_email: 'a.ogunfusika@gmail.com', //put your email here.
//           message: form.message,
//         },
//         'utmDvPSoZDfWgXUWk' //paste your Public Key here. You'll get it in your profile section.
//       )
//       .then(
//         () => {
//           setLoading(false);
